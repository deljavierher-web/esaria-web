...
/* ── Chat Flow Data ── */
var FLOW = [{"id": "btn-revision", "label": "👁️ Pedir cita para revisión", "userMsg": "Quería pedir cita para una revisión de la vista", "botResponses": ["Déjame comprobar la agenda... 📋", "✅ <b>Cita confirmada</b><br><br>📅 Viernes 11:00<br>👁️ Revisión visual completa<br>⏱️ Duración: 30 minutos<br><br>Trae tus gafas actuales si las tienes. ¡Te esperamos! 😊"], "backendAction": "book_optic"}, {"id": "btn-gafas", "label": "📦 ¿Están mis gafas listas?", "userMsg": "¿Ya están listas mis gafas nuevas?", "botResponses": ["Déjame consultar tu pedido... 🔍", "✅ <b>¡Sí, ya están listas!</b><br><br>📦 Pedido #456 — Gafas progresivas<br>🏪 Puedes recogerlas en horario de tienda<br>⏰ L-V: 10:00–20:00<br><br>¡Te quedan genial! 😎"], "backendAction": "glasses_ready"}];
var ACTIONS = {"book_optic": [{"id": "opt-1100-name", "prop": "textContent", "val": "Nuevo — Revisión visual"}, {"id": "opt-1100-st", "prop": "textContent", "val": "✅ Reservada"}, {"id": "opt-1100-st", "prop": "className", "val": "bp-slots conf"}, {"id": "opt-1100", "prop": "addclass", "val": "bp-updated"}], "glasses_ready": [{"id": "pedido-456-st", "prop": "textContent", "val": "✅ Lista para recogida"}, {"id": "pedido-456-st", "prop": "className", "val": "bp-stext ready"}, {"id": "pedido-456", "prop": "addclass", "val": "bp-updated"}]};
var NOMBRE = 'VL ÓPTICOS Centro de Óptica y Audífonos';
