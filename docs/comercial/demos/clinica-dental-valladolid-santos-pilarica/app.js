...
/* ── Chat Flow Data ── */
var FLOW = [{"id": "btn-cita", "label": "📅 Pedir cita para revisión", "userMsg": "Hola, quería pedir cita para una revisión dental", "botResponses": ["Déjame mirar la agenda... 📋", "✅ <b>Cita reservada</b><br><br>📅 Jueves 12:30<br>👨‍⚕️ Revisión completa<br>📍 Consulta 2<br><br>Te enviaremos un recordatorio el día antes. ¡Hasta pronto! 😊"], "backendAction": "book_dental"}, {"id": "btn-precio", "label": "💰 ¿Cuánto cuesta una limpieza?", "userMsg": "¿Cuánto cuesta una limpieza dental?", "botResponses": ["¡Buena pregunta! Aquí tienes los precios:", "🦷 <b>Limpieza dental</b>: 45€<br>✨ <b>Blanqueamiento</b>: desde 199€<br>🔍 <b>Revisión completa</b>: Gratuita<br><br>¿Quieres que te reserve una cita? 😊"], "backendAction": null}];
var ACTIONS = {"book_dental": [{"id": "cita-1230-name", "prop": "textContent", "val": "Nuevo Paciente — Revisión"}, {"id": "cita-1230-st", "prop": "textContent", "val": "✅ Reservada"}, {"id": "cita-1230-st", "prop": "className", "val": "bp-slots conf"}, {"id": "cita-1230", "prop": "addclass", "val": "bp-updated"}]};
var NOMBRE = 'Clinica Dental Valladolid SANTOS PILARICA';
