...
.nav-logo{font-size:1.4rem;font-weight:800;color:#A78BFA;background:linear-gradient(135deg,#6D5EF3,#A78BFA);-webkit-background-clip:text;background-clip:text;letter-spacing:-.02em}
...
.hero h1 .hl{color:#A78BFA;background:linear-gradient(135deg,#6D5EF3,#A78BFA);-webkit-background-clip:text;background-clip:text}
...
.p-card h2 .hl{color:#A78BFA;background:linear-gradient(135deg,#6D5EF3,#A78BFA);-webkit-background-clip:text;background-clip:text}
...
.footer-logo{font-size:1.2rem;font-weight:800;color:#A78BFA;background:linear-gradient(135deg,#6D5EF3,#A78BFA);-webkit-background-clip:text;background-clip:text;margin-bottom:.5rem}
...
/* Degradado en texto solo si el WebView soporta background-clip:text; si no, queda el color solido de respaldo */
@supports ((-webkit-background-clip:text) or (background-clip:text)){.nav-logo,.hero h1 .hl,.p-card h2 .hl,.footer-logo{-webkit-text-fill-color:transparent}}
