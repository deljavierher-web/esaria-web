...
def main():
    ...
    style = (
        "Narrador profesional español para un Reel B2B con humor local suave. "
        "Tono cercano, irónico y natural, como alguien de Valladolid hablando con una pyme. "
        "No sonar a anuncio agresivo. Ritmo ágil. Duración objetivo: 24 segundos. "
        "Pronuncia Esaría con acento claro."
    )
