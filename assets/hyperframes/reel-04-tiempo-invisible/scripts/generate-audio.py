...
def main():
    ...
    style = (
        ...
        "Voz adulta, seria pero cercana. Acento español de España. "
        "Ritmo ágil, claro y natural, sin sonar exagerado ni juvenil. "
        "Duración objetivo: 18 segundos. Pausas muy breves entre frases."
    )
